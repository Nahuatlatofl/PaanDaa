...
<head>
    ...
    <link rel="stylesheet" href="estilo/contenido.css">
    <link rel="stylesheet" href="estilo/pie.css">
    <script src="https://kit.fontawesome.com/55d55a560c.js" crossorigin="anonymous"></script>
        ...
        <ul>
            ...
            <li>
                ...
                <a href="index.php">
                    ...
                    <div class="texto">
                        ...
                        <p>Come uno en el buen sentido</p>
                    </div>
                </a>
            </li><p></p>
            <li>
            ...
            <li>
                <a href="index.php">
                    ...
                    <div class="texto">
                        <h2>!Oing¡ !Oing¡</h2>
                        <p>A que no te atreves a probarlo</p>
                    </div>
                </a>
            </li>
            <li>
    ...
    <footer class="pie-pagina">
        <div class="grupo-1">
            <div class="box">
                <figure>
                    <a href="#">
                        <img src="estilo/imagen/LOGO.jpg" alt="Logo error">
                    </a>
                </figure>
            </div>
            <div class="box">
                <h2>SOBRE NOSOTROS</h2>
                <p>"Un nuevo gusto al paladar"</p>
            </div>
            <div class="box">
                <h2>SIGUENOS</h2>
